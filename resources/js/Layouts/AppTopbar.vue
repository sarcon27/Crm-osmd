...
const userMenuItems = ref([
    { label: 'Выход', icon: 'pi pi-fw pi-sign-out', route: 'logout' }
]);

const user = usePage().props.user
const siteName = computed(() => usePage().props.site_name)
...
<template>
    <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            <Link :href="route('dashboard.index')" class="layout-topbar-logo">
...
<!--                    </button>-->
                    ...
                    <button type="button" class="layout-topbar-action" @click="$refs.userMenu.toggle($event)"><i class="pi pi-user"></i></button>
                    <Menu ref="userMenu" popup :model="userMenuItems" class="!min-w-40">
                        <template #item="{ item, props }">
                                <Link :href="item.route" class="" v-bind="props.action" @click="navigate">
