...
<!--                            </g>-->
<!--                        </svg>-->
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-10">Welcome!</div>
                    ...
                    <div>
                        ...
                        <form @submit.prevent="auth" class="">
                            <label for="email1" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Email</label>
                            <InputText id="email1" type="text" placeholder="Email address"
                                       class="w-full md:w-[30rem] mb-2"
                                       v-model="form.email" :invalid="form.errors.email"/>
                            <template v-if="form.errors.email">
                                <Message severity="error" size="small" variant="simple">{{ form.errors.email }}</Message>
                            </template>

                            <label for="password1" class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2 mt-2">Password</label>
                            <Password id="password1" v-model="form.password" placeholder="Password" :toggleMask="true"
                                      class="mb-2" fluid :feedback="false" :invalid="form.errors.password"></Password>
                            <template v-if="form.errors.password">
                                <Message severity="error" size="small" variant="simple">{{ form.errors.password }}</Message>
                            </template>

                            <Button type="submit" label="Sign In" class="w-full mt-4"></Button>
                        </form>
